export function CorrigirTexto(Text){
...
export function TotalStatus(Status){
  let Contador = 0
...
export function GenderRate(Genero){
  if (Genero >= 0){
...
export function Habilidades(Abilities){
  let Lista = ''
...
export function Catch(Porcentagem){
  return ((Porcentagem / 255) * 100).toFixed(2) + '%'
}

export function MetricaFelicidade(Felicidade){
