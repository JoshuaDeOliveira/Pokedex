...
export function RunPokemonHTML(){
  ...
  async function CriaçãoData() {
    const Data = await BuscadorPoke(IDPoke)
    InicialHTML(Data)
  }
...
function InicialHTML(){
  let HTML;
  let InserirHTML = document.querySelector('.Main')
...
function BaseHTML(){
  HTML = `        <div class="Pokedex-Infos">
            ...
            <div class="Type-Pokemon">
              <div class="Div-Type">
                <img class="Type-Icon" src="../../CSS/Imagens/IconTypes/electric.png" alt="">
              </div>
            </div>
            <div class="Info-Dex">
